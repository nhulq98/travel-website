            ...
            <div class="col-lg-12">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $result = mysqli_query($conn, 'select count(id) as total from tblgopy');
                        ...
                        $sql = "SELECT * FROM tblgopy ORDER BY id DESC LIMIT {$start},{$limit}";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($comment = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $comment["diachi"]; ?></td>
                                    <td><?php echo $comment["dienthoai"]; ?></td>
                                    <td><?php echo $comment["email"]; ?></td>
                                    <td><?php echo $comment["noidung"]; ?></td>
                                    <td align="center"><a onclick="return confirm('Bạn có muốn xóa không');" href="delete_comment.php?id=<?php echo $comment['id']; ?>"><img width="25" src="../images/icon_deletenv.png"></a></td>
                                </tr>
                            <?php
                        }
                    } else {
                ...
                <ul class="pagination">
                    ...
                    if ($current_page > 1 && $total_page > 1) {
                        echo '<li><a href="comment.php?page=' . ($current_page - 1) . '">Prev</a></li>';
                    }
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        if ($i == $current_page) {
                            ...
                            echo '<li><a href="comment.php?page=' . $i . '">' . $i . '</a></li>';
                        }
                    }

                    // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
                    if ($current_page < $total_page && $total_page > 1) {
                        echo '<li><a href="comment.php?page=' . ($current_page + 1) . '">Next</a></li>';
                    }
                    ?>
                </ul>
            </div>
